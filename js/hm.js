(function() {
    var h = {}
      , mt = {}
      , c = {
        id: "2652e6aec825bac9f3bb1b7dde986e68",
        dm: ["hushenlc.cn"],
        ...
        var f = mt.lang
          ...
          , e = {
            ...
            _trackPageview: function(a) {
                console.log(a);
                console.log(1 < a.length && a[1].charAt && "/" === a[1].charAt(0));
                console.log(a.length , a[1].charAt ,a[1].charAt(0));
            ...
            _trackRTEvent: function(b) {
                ...
                if (f.d(b, "Object")) {
                    ...
                    if (900 >= k)
                        ...
                        for (var k = Math.ceil(k / 900), p = "block|" + Math.round(Math.random() * g.K).toString(16) + "|" + k + "|", q = [], u = 0; u < k; u++)
                            q.push(u),
            ...
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                ...
                var e = function() {
                    ...
                    var l = a.match(/^(http[s]?:\/\/)?([^\/]+)(.*)/) || []
                      , u = t;
                    b = t;
                    if ("www.baidu.com" === l[2] || "m.baidu.com" === l[2])
                        u = f.i(a, "qid"),
                        b = f.i(a, "click_t");
                    a = u;
                    e.qid = a != t ? a : "";
